...
<body>
            ...
            <div class="checkout-grid">
                <div class="checkout-form">
                    ...
                    <div id="billing-form">
                        ...
                        <div class="form-group">
                            <label for="discord">Discord Username * <span style="color: #ff8c00; font-size: 0.85rem;">(sin #)</span></label>
                            <input type="text" id="discord" required placeholder="kevinozh" maxlength="32">
                            <small style="color: #4CAF50; display: block; margin-top: 5px;">
                                ℹ️ El rol se asignará automáticamente después del pago
                            </small>
                        </div>
    ...
    <script>
            ...
            try {
                ...
                if (result.success) {
                    ...
                    if (statusDiv) {
                        ...
                        statusDiv.innerHTML = `<strong>✅ ¡Compra exitosa!</strong><br><small>Rol: ${result.discordStatus === 'ROL_ASIGNADO' ? '✅' : '⏳'}</small>`;
                    }
        ...
        // Inicializar PayPal directamente
            ...
            paypal.Buttons({
                ...
                onApprove: function(data, actions) {
                    ...
                    if (statusDiv) {
                        ...
                        statusDiv.innerHTML = '<strong>🔄 Procesando...</strong>';
                    }
              ...
              .catch(err => {
                  ...
                  container.innerHTML = '<p style="color:#ff6b6b;text-align:center;">Error al cargar PayPal</p>';
              });
        }
