...
// ✅ Configuración de precios ($0.99 para pruebas)
const vipConfig = {
    vip: { price: 0.99, name: 'VIP (Básico)' },
    gold: { price: 0.99, name: 'VIP GOLD' },
    diamond: { price: 0.99, name: 'VIP DIAMOND' }
};

function initializePayPal(vipType) {
    console.log('🔄 Inicializando PayPal LIVE para:', vipType);
    currentVIP = vipType;
    ...
    console.log('✅ PayPal SDK LIVE cargado - Precio: $' + price);
    ...
    paypal.Buttons({
      ...
      .then(function() {
          console.log('✅ Botón PayPal LIVE renderizado correctamente');
      })
      .catch(function(error) {
...
function hideLoadingModal() {
    // El modal se mantiene para mostrar la confirmación
}
...
function showPaymentStatus(msg, type) {
    ...
    // Auto-ocultar warnings después de 5 segundos
    if (type === 'warning') {
...
console.log('💰 Precios de prueba: $0.99 USD');